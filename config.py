...
#    Желательно   изменить    #
###############################
passwd: str or None  = '12'           # ! Код доступа (None - отключить)
...
#   Изменять не обязательно   #
###############################
msg_regex_tme: bool     = True                                                    # ? Замена t.me/*, t.me/*/id на /chat/*
msg_replace_regex: str  = r"(https?://)?t\.me/(?P<chat>[A-Za-z0-9-_]{3,20})/?\d*" # ? Регулярное выражение для поиска ссылок
msg_regex_to: str       = r"/chat/\g<chat>"                                       # ? Замена на локал. ссылки
